...
if( $action == "del" ) {
	...
	if( dle_strlen( $group_name, $config['charset'] ) > 50 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $group_icon, $config['charset'] ) > 200 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
