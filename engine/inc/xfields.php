...
<tr id="$holderid" {$uid}>
<td class="addnews">$value[1]:</td>
<td class="xfields" colspan="2"><div id="xfupload_{$fieldname}"></div><input type="hidden" name="xfield[$fieldname]" id="xf_$fieldname" value="{$fieldvalue}" {$params}/>[not-optional]<span class="note large">{$lang['xf_notig']}</span>[/not-optional]
<script type="text/javascript">
{$del_function}
</script>
</td>
