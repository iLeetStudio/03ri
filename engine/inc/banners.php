...
if( $_POST['action'] == "doadd" ) {
	...
	if( dle_strlen( $banner_tag, $config['charset'] ) > 40 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $banner_descr, $config['charset'] ) > 200 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $banner_code, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $category, $config['charset'] ) > 255 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
