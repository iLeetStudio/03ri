...
elseif( $action == "doaddnews" ) {
	...
	if( dle_strlen( $category_list, $config['charset'] ) > 190 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	...
	if( dle_strlen( $short_story, $config['charset'] ) > 1677700 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $full_story, $config['charset'] ) > 1677700 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	...
	if( dle_strlen( $vote_title, $config['charset'] ) > 200 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $frage, $config['charset'] ) > 200 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	...
	if( dle_strlen( $metatags['description'], $config['charset'] ) > 200 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $metatags['keywords'], $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $metatags['title'], $config['charset'] ) > 255 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $group_regel, $config['charset'] ) > 150 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
