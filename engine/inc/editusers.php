...
elseif( $action == "doedituser" ) {
	...
	if( dle_strlen( $filecontents, $config['charset'] ) > 65000 ) die($lang['content_error']);
	if( dle_strlen( $editinfo, $config['charset'] ) > 65000 ) die($lang['content_error']);
	if( dle_strlen( $editsignature, $config['charset'] ) > 65000 ) die($lang['content_error']);
	if( dle_strlen( $editland, $config['charset'] ) > 100 ) die($lang['content_error']);
	if( dle_strlen( $editfullname, $config['charset'] ) > 100 ) die($lang['content_error']);
	if( dle_strlen( $editlogin, $config['charset'] ) > 40 ) die($lang['content_error']);
	...
	if( $banned ) {
		...
		if( dle_strlen( $banned_descr, $config['charset'] ) > 65000 ) die($lang['content_error']);
