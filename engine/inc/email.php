...
if( $action == "save" ) {
	...
	if( dle_strlen( $reg_mail_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	if( dle_strlen( $feed_mail_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	if( dle_strlen( $lost_mail_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	if( dle_strlen( $new_news_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	if( dle_strlen( $new_comments_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	if( dle_strlen( $new_pm_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	if( dle_strlen( $new_newsletter_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	if( dle_strlen( $wait_mail_text, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
