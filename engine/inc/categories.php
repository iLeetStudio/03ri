...
if( $action == "add" ) {
	...
	if( dle_strlen( $cat_name, $config['charset'] ) > 50 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $alt_cat_name, $config['charset'] ) > 50 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $cat_icon, $config['charset'] ) > 200 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	...
	if( dle_strlen( $keywords, $config['charset'] ) > 65000 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $short_tpl, $config['charset'] ) > 40 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $full_tpl, $config['charset'] ) > 40 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
	
	if( dle_strlen( $meta_title, $config['charset'] ) > 255 ) {
		msg( "error", $lang['addnews_error'], $lang['content_error'], "javascript:history.go(-1)" );
	}
