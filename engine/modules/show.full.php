					...
					if( $xfound ) {
						...
						foreach ( $xfields as $value ) {
							...
							if($value[3] == "imagegalery" AND $xfieldsdata[$value[0]] AND stripos ( $tpl2->copy_template, "[xfvalue_{$value[0]}]" ) !== false ) {
								...
								$onload_scripts[] = "hs.addSlideshow({slideshowGroup: 'xf_{$related['id']}_{$value[0]}', interval: 4000, repeat: false, useControls: true, fixedControls: 'fit', overlayOptions: { opacity: .75, position: 'bottom center', hideOnMouseOut: true } });";
